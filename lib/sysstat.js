...
function init() {
  new sysstat.Cpu(cpuLine); //no Windows support
  new sysstat.Mem(memLine, memDonut, swapDonut);
  new sysstat.Net(netSpark);
  new sysstat.Disk(diskDonut);
  new sysstat.Proc(procTable); // no Windows support
}

...
var blessed = require('blessed'),
  ...
  statModules = require('./statModules');
...
function init() {
  new statModules.cpu(cpuLine); //no Windows support
  new statModules.Mem(memLine, memDonut, swapDonut);
  new statModules.Network(netSpark);
  new statModules.Disk(diskDonut);
  new statModules.proc(procTable); // no Windows support
}
